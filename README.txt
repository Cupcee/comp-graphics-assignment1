...
Student name: Samuel Piirainen
Student number: 593818
...
Department of Computer Science, studying Computer Science as major, Stats as minor.
...
I have around 3 years worth of programming experience now from school courses, some small hobby projects
and more recently working as a software developer.
I'm most comfortable with (obviously) Scala, C#, Javascript and its frameworks and Python. I also 
know C via the Aalto C-programming course.

- Do you have some experience with these things? (If not, do you have experience with something similar such as C or Direct3D?)
C++: Barely. I'm doing the C++ Aalto course right now though!
C++11: Barely. I'm doing the C++ Aalto course right now though!
OpenGL: No.
I have experience with C.

- Have you used a version control system such as Git, Mercurial or Subversion? Which ones?
I have used a lot of Git and some TFS.
